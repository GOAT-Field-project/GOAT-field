      ...
      <div className="flex z-100 bg-white">
        ...
        <div className="flex w-full flex-col md:w-1/2">
          <div className="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-8 md:justify-start md:px-6 md:pt-0">
            ...
            <p className="text-left text-3xl font-bold">Create an account now</p>
            <p className="mt-5 text-left text-sm text-gray-500">
              Already have an account?
              <Link to="/login" className="ml-2 text-sm text-green-500 cursor-pointer hover:text-green-800">Login</Link>
            </p>
            <form className="flex flex-col pt-3 md:pt-8" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col pt-4">
                <div className="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                  <div className='mt-3'>
                    <svg viewBox="0 0 1024 1024" className='h-5 w-5 b' xmlns="http://www.w3.org/2000/svg">
                      <path fill="#82CD47" d="M288 320a224 224 0 1 0 448 0 224 224 0 1 0-448 0zm544 608H160a32 32 0 0 1-32-32v-96a160 160 0 0 1 160-160h448a160 160 0 0 1 160 160v96a32 32 0 0 1-32 32z" />
                    </svg>
                  </div>
                  <input
                    type="text"
                ...
                {errorResponse && <p className='text-red-600'>{errorResponse}</p>}
              </div>
              <div className="flex flex-col pt-4">
                <div className="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                  <div className='mt-3'>
                    <svg viewBox="0 0 8 6" className='h-5 w-5 b' xmlns="http://www.w3.org/2000/svg">
                      <path fill="#82CD47" d="m0 0h8v6h-8zm.75 .75v4.5h6.5v-4.5zM0 0l4 3 4-3v1l-4 3-4-3z" />
                    </svg>
                  </div>
                  <input
                    type="email"
                ...
                <div className="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                  <div className="mt-3">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24">
                      <path fill="#82CD47" d="M17,9V7c0-2.8-2.2-5-5-5S7,4.2,7,7v2c-1.7,0-3,1.3-3,3v7c0,1.7,1.3,3,3,3h10c1.7,0,3-1.3,3-3v-7C20,10.3,18.7,9,17,9z M9,7c0-1.7,1.3-3,3-3s3,1.3,3,3v2H9V7z M13,17c0,0.6-0.4,1-1,1s-1-0.4-1-1v-3c0-0.6,0.4-1,1-1s1,0.4,1,1V17z" />
                    </svg>
        ...
        <div className="pointer-events-none relative hidden h-screen select-none md:block md:w-1/2">
          <div>
            <div className="absolute bottom-0 z-10 px-8 text-white opacity-100">
              <p className="mb-72 text-3xl font-semibold leading-10">We work 10x faster than our competitors and stay consistent. While theyre bogged down with technical debt, were releasing new features.</p>
            </div>
            <img
